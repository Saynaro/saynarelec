...
const ToastAction = React.forwardRef(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "inline-flex h-8 shrink-0 items-center justify-center rounded-lg border border-navy/15 bg-transparent px-3 text-xs font-medium text-navy hover:bg-navy/5 transition-colors focus:outline-none",
      className
    )}
    {...props}
  />
...
const ToastClose = React.forwardRef(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "rounded-md p-1 text-navy/40 transition-colors hover:text-navy focus:outline-none shrink-0 mt-0.5",
      className
    )}
    toast-close=""
    {...props}
...
const ToastTitle = React.forwardRef(({ className, ...props }, ref) => (
  <ToastPrimitives.Title
    ref={ref}
    className={cn("text-sm font-semibold tracking-tight text-navy", className)}
    {...props}
  />
));
...
const ToastDescription = React.forwardRef(({ className, ...props }, ref) => (
  <ToastPrimitives.Description
    ref={ref}
    className={cn("text-xs text-navy/70 leading-relaxed", className)}
    {...props}
  />
));
